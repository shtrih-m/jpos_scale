...
Uses
  // VCL
  Classes, SysUtils, Forms, Grids, Controls,
  // This
  AddIn_TLB;
...
type
  ...
  private
    FDrvSM: TDrvSM;
    function GetDrvSM: TDrvSM;
  public
    destructor Destroy; override;
    property DrvSM: TDrvSM read GetDrvSM;
  end;
  ...
  protected
    ...
    property Driver: TDrvSM read GetDrvSM;
  public
    constructor CreatePage(AOwner: TComponent; ADriver: TDriver); virtual;
...
function TDriver.GetDrvSM: TDrvSM;
begin
  if FDrvSM = nil then
    FDrvSM := TDrvSM.Create(nil);
  Result := FDrvSM;
end;

{ TPage }

constructor TPage.CreatePage(AOwner: TComponent; ADriver: TDriver);
begin
  inherited Create(AOwner);
  FDriver := ADriver;
end;

function TPage.GetDrvSM: TDrvSM;
begin
  Result := FDriver.DrvSM;
end;
